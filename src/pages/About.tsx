...
const About = () => {
  return (
    <div className="min-h-screen">
      <SEO
        title="About"
        description="ARCH STUDIO is a minimal architecture practice founded in 2015. Over 200 residential, commercial, and cultural projects guided by research, collaboration, and innovation."
        path="/about"
      />
      <Navigation />
