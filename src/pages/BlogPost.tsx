...
import { SEO, buildBlogPostJsonLd } from "@/components/SEO";
      ...
      <article className="pt-32 pb-32">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            ...
            {/* Article Meta */}
            <div className="mb-8">
              <div className="flex flex-wrap items-center text-minimal text-muted-foreground gap-x-4 gap-y-2 mb-6">
                ...
                {blogPosts
                  ...
                  .map(relatedPost => (
                    <Link
                      ...
                      className="group focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-4 rounded-sm"
                    >
